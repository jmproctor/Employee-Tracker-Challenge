...
console.log("Welcome to your Employee Management Tool!");
    ...
    inquirer
        .prompt({
            ...
            choices: [
                ...
                {name: 'Ashley Tisdale', value: 3}, 
                {name: 'Devon Willson', value: 5}, 
                {name: 'Allison Allen', value: 7}
            ]})
        .then(function(answer) {
...
function updateRole() {
    inquirer
        .prompt([{
            ...
            choices: [
                {name: 'John Smith', value: 1},
                {name: 'Bill Engvall', value: 2},
                {name: 'Ashley Tisdale', value: 3},
                {name: 'Judah Juarez', value: 4},
                {name: 'Devon Willson', value: 5},
                {name: 'Stewart Brown', value: 6},
                {name: 'Allison Allen', value: 7},
                {name: 'Jace Haas', value: 8}
            ]
        },
        {
            name: 'title',
